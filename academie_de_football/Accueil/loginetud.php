		...
		<div class="card">
			<div class="inner-box" id="card">
				<div class="card-front">
					<h2>Connecté Parent(e)</h2>
					<form method="POST" action="" >
					<input type="text" class="input-box" placeholder="Numero Parent" name="num_etudiant" required>
				...
				<h2>Modifier Votre Mdp</h2>
					<form  method="POST" action="">
						<input type="text" class="input-box" placeholder="Numero etudiant" name="num_etudiant" required>
