		...
		<div class="card">
			<div class="inner-box" id="card">
				<div class="card-front">
					...
					<input type="text" class="input-box" placeholder="Nom" name="num_etudiant" required>
                                                <input type="text" class="input-box" placeholder="prenom" name="num_etudiant" required>
                                                <input type="text" class="input-box" placeholder="adresse" name="num_etudiant" required>
                                                <input type="text" class="input-box" placeholder="Age" name="num_etudiant" required>
                                                <input type="text" class="input-box" placeholder="date naissance" name="num_etudiant" required>
                                                <input type="text" class="input-box" placeholder="ID equipe" name="num_etudiant" required>
                                                <input type="text" class="input-box" placeholder="ID parent" name="num_etudiant" required>
						<input type="password" class="input-box" placeholder="Mot de passe" name="mot_passe_etudiant" required>
